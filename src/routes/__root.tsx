  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-muted-foreground">This trail doesn't exist.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alpha Life — Lead the Pack" },
      { name: "description", content: "Trading discipline app: strategy checklist, position size calculator, journal, and equity dashboard." },
      { property: "og:title", content: "Alpha Life — Lead the Pack" },
